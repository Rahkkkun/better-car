          ...
          <CardContent className="p-6">
            ...
            <div className="text-sm">
              <p className="font-medium">
                {dealership?.name || "Better-Car Motors"}
              </p>
      ...
      <div className="md:col-span-2">
        <Card>
          <CardContent className="p-6">
            ...
            {/* Instructions */}
            <div className="mt-8 bg-gray-50 dark:bg-black p-4 rounded-lg">
              <h3 className="font-medium mb-2 text-gray-900 dark:text-white">What to expect</h3>
