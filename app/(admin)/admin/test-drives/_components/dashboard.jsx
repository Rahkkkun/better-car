              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
                    <h3 className="font-medium text-sm mb-2 text-gray-900 dark:text-white">Car Inventory</h3>
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Cars Sold</p>
                  </div>
                  <div className="text-center">
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="space-y-4 mt-4">
                  <h3 className="font-medium text-gray-900 dark:text-white">Booking Status Breakdown</h3>
