  ...
  return (
    <div className="flex lg:flex-col justify-between gap-4">
      ...
      <div className="hidden lg:block sticky top-24">
        <div className="border rounded-lg overflow-hidden bg-white dark:bg-black shadow-sm border-gray-200 dark:border-gray-800">
          <div className="p-4 border-b bg-gray-50 dark:bg-black border-gray-200 dark:border-gray-800 flex justify-between items-center">
