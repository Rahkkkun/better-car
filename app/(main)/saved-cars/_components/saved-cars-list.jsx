...
export function SavedCarsList({ initialData }) {
  ...
  if (!initialData?.data || initialData?.data.length === 0) {
    return (
      <div className="min-h-[400px] flex flex-col items-center justify-center text-center p-8 border rounded-lg bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-800">
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-full mb-4">
          <Heart className="h-8 w-8 text-gray-500 dark:text-gray-400" />
        </div>
        <h3 className="text-lg font-medium mb-2 text-gray-900 dark:text-white">No Saved Cars</h3>
